    ...
    public class ImportFixture : CoreTest<CompletedDownloadService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IHistoryService>()
                  ...
                  .Returns(new History.EpisodeHistory());
        ...
        private void GivenABadlyNamedDownload()
        {
            ...
            Mocker.GetMock<IHistoryService>()
               ...
               .Returns(new History.EpisodeHistory() { SourceTitle = "Droned S01E01" });
        ...
        public void should_mark_as_imported_if_all_episodes_were_imported_including_history()
        {
            ...
            Mocker.GetMock<ITrackedDownloadAlreadyImported>()
                  .Setup(s => s.IsImported(It.IsAny<TrackedDownload>(), It.IsAny<List<History.EpisodeHistory>>()))
                  .Returns(true);
