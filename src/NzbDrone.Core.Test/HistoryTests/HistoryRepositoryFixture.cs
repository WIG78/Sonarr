...
{
    [TestFixture]
    public class HistoryRepositoryFixture : DbTest<HistoryRepository, History.EpisodeHistory>
    {
        ...
        {
            var historyBluray = Builder<History.EpisodeHistory>.CreateNew()
            ...
            var historyDvd = Builder<History.EpisodeHistory>.CreateNew()
